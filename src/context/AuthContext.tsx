...
const SUPERADMIN_USER: AuthUser = {
  ...
  module_access: [
    ...
    'user-management',
    'inventory', 'fuels-consumables', 'inventory-inbox',
    'vendor-directory',
    'purchase-flow', 'work-order', 'scope-of-work', 'purchase-inbox',
    'hrms', 'staff-onboarding', 'hrms-inbox',
    'vehicle-management',
    'cultivation-calendar', 'cultivation-master', 'cultivation-plan',
    'field-visit-analytics', 'labour-management',
    'harvest-orders',
    'weighment',
    'accounts-dashboard', 'accounts-ledger', 'accounts-payments',
  ],
};
