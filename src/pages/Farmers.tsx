      ...
      if (row.id === id) {
        ...
        if (field === 'farmerId') {
          ...
          if (selectedFarmer) {
            ...
            // Optionally auto-fill village from farmer
        ...
        <TabsContent value="blocks">
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <Dialog open={isBlockModalOpen} onOpenChange={(open) => {
              ...
              if (open) {
                // Fetch available farms for block creation
                    ...
                    <div className="mb-1">
                      <div className="bg-muted/50 border border-border rounded-lg px-6 py-3 flex flex-col items-center min-w-[120px]">
                        ...
                        <span className="text-xl font-bold">
                          {(() => {
                            // Sum up all acres from fetchedDetails (format: 'X Acres in ...')
                            let total = 0;
                ...
                <DialogFooter>
                  ...
                  <Button
                    ...
                    disabled={
                      !blockName.trim() ||
                      landRows.length === 0 ||
                      landRows.every(row => !row.farmerId)
                    }
                  >
                    Save Block
                  </Button>
                  ...
                  <div className="flex-1 flex flex-col justify-between p-6">
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-xs text-green-700 bg-green-100 px-2 py-1 rounded-full font-semibold tracking-wide shadow-sm border border-green-200">ID: {block.block_id.slice(0, 8)}...</span>
                      </div>
                      <div className="flex items-center gap-3 mt-2">
                        <span className="text-base font-medium text-green-800">Total Area</span>
                        <span className="text-2xl font-extrabold text-green-900 drop-shadow-sm">{block.total_area ?? 0} <span className="text-base font-semibold">acres</span></span>
                      </div>
                    </div>
          ...
          <Dialog open={isViewBlockModalOpen} onOpenChange={setIsViewBlockModalOpen}>
            <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
              ...
              {/* You can reuse the create block UI here, prefill with viewBlock data if needed */}
              {/* For now, just show block name and area, and a placeholder for farmer list */}
              {viewBlock && (
                <div className="space-y-6 py-4">
                  <div className="flex gap-4 items-end">
                    <div className="flex-1 space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="bg-muted/20 border rounded-lg p-4 min-h-[60px]">
                      {/* TODO: Show farmer list for this block, and add UI to add new farmers */}
